    ...
    <footer className="bg-green-700 text-white py-10 rounded-t-[5rem]">
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-start gap-8 mb-8">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col gap-2">
              <a
                href="https://rdd.maharashtra.gov.in/"
                target="_blank"
              ...
              <a
                href="https://www.zpsolapur.gov.in/"
                target="_blank"
                className="text-white hover:underline flex items-center gap-1"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="mb-0">
            &copy; 2025 Developed by <span className="font-bold">SDG INFOWEB</span>
          </p>
          ...
          <div className="flex gap-4 mt-2 md:mt-0">
            ...
            <a
              href="https://mail.google.com/mail/?view=cm&fs=1&to=shirawalwadi55@gmail.com&su=Hello&body=I%20want%20to%20contact%20you"
              target="_blank"
